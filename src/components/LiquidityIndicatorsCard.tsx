...
import { Droplets, Activity, Layers } from 'lucide-react';
  ...
  return (
    <div className="bg-[#0e0f14] border border-white/10 rounded-2xl p-5 shadow-2xl space-y-5">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-white/10 pb-3">
        ...
        <span className="px-2.5 py-1 rounded-full bg-white/10 text-slate-200 text-[11px] font-mono border border-white/10">
          Formulas A, B & D Engine
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[#151620] border border-white/10 rounded-xl p-4 space-y-2">
          ...
          <div className="text-[11px] text-slate-400 font-mono flex items-center justify-between pt-1 border-t border-white/10">
      ...
      {/* Liquidity Score Time-Series Chart (Graph dataset colors retained) */}
      <div className="space-y-2 pt-2">
        <div className="flex items-center justify-between text-xs text-slate-400">
          <span className="font-medium text-slate-300">Interval Liquidity Score Time-Series (Formula D):</span>

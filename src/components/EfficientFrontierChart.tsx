      ...
      <div className="h-[240px] w-full">
        <ResponsiveContainer width="100%" height="100%">
          <ScatterChart margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
            ...
            />
            <Scatter name="Efficient Frontier" data={frontierPoints} fill="#ffffff" line stroke="#ffffff" />
          </ScatterChart>
        </ResponsiveContainer>
      </div>
      <p className="text-[11px] text-slate-400 text-center">
        Left-most points represent high risk-aversion (&lambda; high, fast execution). Right-most points represent low risk-aversion (&lambda; low, slow execution).
      </p>
    </div>
  );
};
